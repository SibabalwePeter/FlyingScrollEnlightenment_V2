...
const questions = [
    ...
    'F Fix a control panel',
    'J Help friends with personal problems',
    'C Oversee a logging crew',
    'B Study weather conditions',
    'P Pack boxes at warehouse',
    'A Teach dancing',
    'P Sterilize surgical instruments',
    'B Study Soil conditions',
    'M Trade stock market',
    'C Protect the environment',
    'P Inspect cargo containers',
    'E Work in cannery',
    'H Coach a school sport team',
    'O Update a website',
    'C Hunt',
    'J Enlish in a branch of military',
    'G Sell sporting goods',
    'I Cut and style hair',
    'G Eperiment to discover new metals',
    'M Work in a bank',
    'F Work with computer programs',
    'M Loan money',
    'K Hang wallpaper',
    'D Make an arrest',
    'N Deliver babies',
